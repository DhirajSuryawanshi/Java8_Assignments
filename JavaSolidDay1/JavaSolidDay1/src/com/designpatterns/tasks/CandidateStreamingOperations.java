package com.designpatterns.tasks;
...
public class CandidateStreamingOperations {
	...
	public static void main(String[] args) {
		...
		candidateList.stream().filter(e -> e.getCity().equalsIgnoreCase("Pune")).forEach(System.out::println);
		System.out.println("--------------------------------");
		...
		candidateList.stream().filter(e -> e.getYearsOfExperience() == 0).forEach(System.out::println);
		System.out.println("--------------------------------");

		// listing candidates with highest experience
		System.out.println("\nSorted List of Candidates by Experience\n");
		candidateList.stream().sorted((p1, p2) -> (p1.getYearsOfExperience() - p2.getYearsOfExperience()))
		...
		candidateList.stream().sorted((p1, p2) -> p1.getCity().compareTo(p2.getCity())).forEach(System.out::println);
		System.out.println("--------------------------------");
	}
